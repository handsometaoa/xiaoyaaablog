import{r as p,o as c,a as r,b as a,d as s,e as n,w as l,F as i,c as t}from"./app.7138fe66.js";import{_ as u}from"./plugin-vue_export-helper.5a098b48.js";const m={},k=a("h1",{id:"\u5206\u53D1\u811A\u672C-ansible",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#\u5206\u53D1\u811A\u672C-ansible","aria-hidden":"true"},"#"),s(" \u5206\u53D1\u811A\u672C ansible")],-1),d=a("p",null,"\u867D\u7136\u4E5F\u53EF\u4EE5\u81EA\u5DF1\u5199 Shell \u5B9E\u73B0\u5206\u53D1\u811A\u672C\uFF0C\u4F46\u7531\u4E8E\u7F3A\u4E4F\u8FD0\u7EF4\u7CFB\u7EDF\u6982\u5FF5\uFF0C\u6DF7\u4E71\u3001\u96F6\u788E\u7684\u5199\u6CD5\u603B\u662F\u8BA9\u4EBA\u96BE\u53D7\uFF0C\u4E00\u63A5\u89E6\u5230 ansible \u5C31\u77E5\u9053\u5F88\u96BE\u56DE\u53BB\u4E86\u3002",-1),h=t(`<p>\u9700\u8981\u6CE8\u610F\u7684\u662F Ansible \u9700\u8981\u5F00\u542F\u516C\u94A5\u8BA4\u8BC1\uFF0C\u4E5F\u5C31\u662F\u6DFB\u52A0\u5230 <code>known_hosts</code> \u4E2D\uFF0C\u5BF9\u4E8E\u5927\u6279\u91CF\u7684\u64CD\u4F5C\u53EF\u4EE5\u7981\u7528\u8BE5\u884C\u4E3A\uFF1A</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">vim</span> /etc/ansible/ansible.cfg
...
</code></pre></div><h2 id="install" tabindex="-1"><a class="header-anchor" href="#install" aria-hidden="true">#</a> install</h2>`,3),b={href:"https://docs.ansible.com/ansible/latest/installation_guide/intro_installation.html#latest-release-via-dnf-or-yum",target:"_blank",rel:"noopener noreferrer"},y=t(`<h3 id="_1-\u5173\u95ED\u9650\u5236" tabindex="-1"><a class="header-anchor" href="#_1-\u5173\u95ED\u9650\u5236" aria-hidden="true">#</a> 1. \u5173\u95ED\u9650\u5236</h3><div class="language-bash ext-sh"><pre class="language-bash"><code>systemctl stop firewalld
...
</code></pre></div>`,2),g={id:"_2-\u5B89\u88C5-python",tabindex:"-1"},_=a("a",{class:"header-anchor",href:"#_2-\u5B89\u88C5-python","aria-hidden":"true"},"#",-1),v={href:"https://www.python.org/downloads/source/",target:"_blank",rel:"noopener noreferrer"},f=t(`<div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">wget</span> https://www.python.org/ftp/python/3.6.9/Python-3.6.9.tar.xz
...
</code></pre></div><h3 id="_4-\u5B89\u88C5-ansible" tabindex="-1"><a class="header-anchor" href="#_4-\u5B89\u88C5-ansible" aria-hidden="true">#</a> 4. \u5B89\u88C5 ansible</h3>`,5),x={href:"https://docs.ansible.com/ansible/latest/installation_guide/intro_installation.html#latest-release-via-dnf-or-yum",target:"_blank",rel:"noopener noreferrer"},w=t(`<div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">git</span> clone https://gitee.com/shanyuhai123/ansible.git
...
</code></pre></div><h3 id="_5-\u542F\u7528-ansible" tabindex="-1"><a class="header-anchor" href="#_5-\u542F\u7528-ansible" aria-hidden="true">#</a> 5. \u542F\u7528 ansible</h3><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">shutdown</span> <span class="token parameter variable">-r</span> now <span class="token comment"># \u91CD\u542F</span>
...
</code></pre></div><p>\u4EC5\u5217\u51FA\u90E8\u5206\u793A\u4F8B\u3002</p>`,14),S={id:"_1-command",tabindex:"-1"},A=a("a",{class:"header-anchor",href:"#_1-command","aria-hidden":"true"},"#",-1),I={href:"https://docs.ansible.com/ansible/latest/modules/command_module.html",target:"_blank",rel:"noopener noreferrer"},M=t(`<p>Execute <strong>command</strong>s on targets\u3002</p><p>\u5B9E\u8DF5\uFF1A</p><div class="language-bash ext-sh"><pre class="language-bash"><code>ansible t1 <span class="token parameter variable">-m</span> <span class="token builtin class-name">command</span> <span class="token parameter variable">-a</span> <span class="token string">&quot;free -m&quot;</span>
...
</code></pre></div>`,3),N={id:"_2-shell",tabindex:"-1"},E=a("a",{class:"header-anchor",href:"#_2-shell","aria-hidden":"true"},"#",-1),F={href:"https://docs.ansible.com/ansible/latest/modules/shell_module.html",target:"_blank",rel:"noopener noreferrer"},P=t(`<p>Execute shell commands on targets\u3002</p><p>\u5B9E\u8DF5\uFF1A</p><div class="language-bash ext-sh"><pre class="language-bash"><code>ansible t1 <span class="token parameter variable">-m</span> shell <span class="token parameter variable">-a</span> <span class="token string">&quot;echo hello &gt; /tmp/tmp.txt&quot;</span>
...
</code></pre></div>`,3),V={id:"_3-copy",tabindex:"-1"},Y=a("a",{class:"header-anchor",href:"#_3-copy","aria-hidden":"true"},"#",-1),B={href:"https://docs.ansible.com/ansible/latest/modules/copy_module.html",target:"_blank",rel:"noopener noreferrer"},C=t(`<p>Copy files to remote locations\u3002</p><p>\u5B9E\u8DF5\uFF1A</p><div class="language-bash ext-sh"><pre class="language-bash"><code>ansible t1 <span class="token parameter variable">-m</span> copy <span class="token parameter variable">-a</span> <span class="token string">&quot;src=/root/shell dest=/tmp&quot;</span>
...
</code></pre></div>`,3),D={id:"_4-script",tabindex:"-1"},H=a("a",{class:"header-anchor",href:"#_4-script","aria-hidden":"true"},"#",-1),R={href:"https://docs.ansible.com/ansible/latest/modules/script_module.html",target:"_blank",rel:"noopener noreferrer"},z=t(`<p>Runs a local script on a remote node after transferring it\u3002</p><p>\u5B9E\u8DF5\uFF1A</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token builtin class-name">echo</span> <span class="token string">&quot;echo hello&quot;</span> <span class="token operator">&gt;</span> /tmp/hello.sh
...
</code></pre></div>`,3),O={id:"_5-file",tabindex:"-1"},G=a("a",{class:"header-anchor",href:"#_5-file","aria-hidden":"true"},"#",-1),T={href:"https://docs.ansible.com/ansible/latest/modules/file_module.html",target:"_blank",rel:"noopener noreferrer"},U=a("p",null,"Manage files and file properties\u3002",-1),W={id:"_6-yum",tabindex:"-1"},X=a("a",{class:"header-anchor",href:"#_6-yum","aria-hidden":"true"},"#",-1),J={href:"https://docs.ansible.com/ansible/latest/modules/yum_module.html",target:"_blank",rel:"noopener noreferrer"},K=t(`<p>Manages packages with the yum package manager\u3002</p><p>\u5B9E\u8DF5\uFF1A</p><div class="language-bash ext-sh"><pre class="language-bash"><code>ansible webservers <span class="token parameter variable">-m</span> <span class="token builtin class-name">command</span> <span class="token parameter variable">-a</span> <span class="token string">&quot;free -m&quot;</span> <span class="token comment"># \u9A8C\u8BC1</span>
...
</code></pre></div>`,3),Q={id:"_7-systemd",tabindex:"-1"},Z=a("a",{class:"header-anchor",href:"#_7-systemd","aria-hidden":"true"},"#",-1),$={href:"https://docs.ansible.com/ansible/latest/modules/systemd_module.html",target:"_blank",rel:"noopener noreferrer"},aa=t(`<p>Manage services\u3002</p><p>\u5B9E\u8DF5\uFF1A</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token comment"># \u6700\u597D\u5C06\u670D\u52A1\u5199\u5B8C\u6574</span>
...
</code></pre></div>`,3),sa={id:"_8-cron",tabindex:"-1"},na=a("a",{class:"header-anchor",href:"#_8-cron","aria-hidden":"true"},"#",-1),ea={href:"https://docs.ansible.com/ansible/latest/modules/cron_module.html",target:"_blank",rel:"noopener noreferrer"},ta=t(`<p>Manage cron.d and crontab entries\u3002</p><p>\u5B9E\u8DF5\uFF1A</p><div class="language-bash ext-sh"><pre class="language-bash"><code>ansible webservers <span class="token parameter variable">-m</span> <span class="token function">cron</span> <span class="token parameter variable">-a</span> <span class="token string">&quot;name=&#39;sync time&#39; minute=00 hour=00 job=&#39;/usr/sbin/ntpdate time.nist.gov &gt; /dev/null 2&gt;&amp;1&#39;&quot;</span> 
...
ansible webservers <span class="token parameter variable">-m</span> <span class="token builtin class-name">command</span> <span class="token parameter variable">-a</span> <span class="token string">&quot;crontab -l&quot;</span> <span class="token comment"># \u9A8C\u8BC1</span>
</code></pre></div><h2 id="playbooks" tabindex="-1"><a class="header-anchor" href="#playbooks" aria-hidden="true">#</a> playbooks</h2><p>\u76F8\u5BF9\u4E8E ad-hoc\uFF0Cplaybooks \u5219\u5F3A\u5927\u7684\u591A\uFF0C\u5F53\u7136\u4E5F\u590D\u6742\u5F97\u591A\u3002playbook \u7531\u4E00\u4E2A\u6216\u591A\u4E2A plays \u7EC4\u6210\uFF0C\u5728 play \u4E2D\uFF0C\u4E00\u7EC4\u673A\u5668\u88AB\u6620\u5C04\u4E3A\u5B9A\u4E49\u597D\u7684\u89D2\u8272\uFF0C\u5176\u5185\u5BB9\u88AB\u79F0\u4E3A tasks\uFF08\u4EFB\u52A1\uFF09\uFF0C\u5728\u57FA\u672C\u5C42\u6B21\u7684\u5E94\u7528\u4E2D\uFF0C\u4E00\u4E2A\u4EFB\u52A1\u662F\u4E00\u4E2A\u5BF9 ansible \u6A21\u5757\u7684\u8C03\u7528\u3002</p>`,5),oa={href:"https://github.com/ansible/ansible-examples",target:"_blank",rel:"noopener noreferrer"},pa=t(`<h3 id="_1-one-play" tabindex="-1"><a class="header-anchor" href="#_1-one-play" aria-hidden="true">#</a> 1. one play</h3><div class="language-yaml ext-yml"><pre class="language-yaml"><code><span class="token punctuation">---</span>
...
roles/
    ...
    monitoring/
    fooapp/
</code></pre></div>`,8);function la(ca,ra){const o=p("RouterLink"),e=p("OutboundLink");return c(),r(i,null,[k,d,a("p",null,[s("Ansible \u662F\u4E00\u4E2A\u7528\u6765\u6279\u91CF\u7BA1\u7406\u90E8\u7F72\u8FDC\u7A0B\u4E3B\u673A\u4E0A\u670D\u52A1\u7684\u5DE5\u5177\uFF0C\u5B83\u901A\u8FC7 SSH \u534F\u8BAE\u5B9E\u73B0\u7BA1\u7406\u8282\u70B9\u4E0E\u8FDC\u7A0B\u8282\u70B9\u4E4B\u95F4\u7684\u901A\u4FE1\uFF0C\u6240\u4EE5\u9996\u5148\u9700\u8981\u5B8C\u6210 "),n(o,{to:"/os/linux/login-with-rsa-key.html#%E7%94%9F%E6%88%90-rsa"},{default:l(()=>[s("SSH \u914D\u7F6E")]),_:1}),s("\u3002")]),h,a("p",null,[s("\u867D\u7136\u53EF\u4EE5\u5F88\u7B80\u5355\u7684\u76F4\u63A5\u4F7F\u7528 "),a("a",b,[s("yum \u5B89\u88C5"),n(e)]),s("\uFF0C\u4F46\u7531\u4E8E ansible \u662F\u4E00\u4E2A python \u7F16\u5199\u7684\u5DE5\u5177\uFF0C\u8FD9\u6837\u5C31\u4F1A\u5BFC\u81F4 ansible \u4F9D\u8D56\u4E8E\u5168\u5C40\u7684 python\uFF0C\u5F53\u5168\u5C40\u4F9D\u8D56\u53D1\u751F\u53D8\u5316\u7684\u65F6\u5019\u53EF\u80FD\u5BFC\u81F4 ansible \u51FA\u73B0\u51B2\u7A81\u6216\u6F5C\u5728\u7684\u5B89\u5168\u95EE\u9898\uFF0C\u6240\u4EE5\u9700\u8981\u9694\u79BB ansible \u4E0E\u5176\u4ED6\u5E94\u7528\u3002")]),y,a("h3",g,[_,s(" 2. \u5B89\u88C5 "),a("a",v,[s("python"),n(e)])]),f,a("p",null,[a("a",x,[s("\u5B98\u7F51"),n(e)]),s("\u63A8\u8350\u7684\u5B89\u88C5\u65B9\u5F0F\uFF0C\u5F53\u4E0B\u8F7D\u901F\u5EA6\u6781\u6162\u65F6\u7684"),n(o,{to:"/tools/github/download-huge-project-from-github.html"},{default:l(()=>[s("\u89E3\u51B3\u65B9\u6848")]),_:1}),s("\u3002")]),w,a("p",null,[s("Ansible \u53EF\u540C\u4E8B\u64CD\u4F5C\u5C5E\u4E8E\u4E00\u4E2A\u7EC4\u7684\u591A\u53F0\u4E3B\u673A\uFF0C\u7EC4\u548C\u4E3B\u673A\u4E4B\u95F4\u7684\u5173\u7CFB\u901A\u8FC7 "),a("a",q,[s("inventory"),n(e)]),s(" \u6587\u4EF6\u914D\u7F6E\u3002\u9ED8\u8BA4\u7684\u6587\u4EF6\u8DEF\u5F84\u4E3A "),L,s("\uFF0C\u9664\u9ED8\u8BA4\u6587\u4EF6\u5916\uFF0C\u8FD8\u53EF\u4EE5\u4F7F\u7528\u591A\u4E2A inventory \u6587\u4EF6\uFF0C\u5F53\u7136\u4E5F\u53EF\u4EE5\u4ECE\u4E91\u4E0A\u62C9\u53D6\u914D\u7F6E\u4FE1\u606F\u3002")]),j,a("h3",S,[A,s(" 1. "),a("a",I,[s("command"),n(e)])]),M,a("h3",N,[E,s(" 2. "),a("a",F,[s("shell"),n(e)])]),P,a("h3",V,[Y,s(" 3. "),a("a",B,[s("copy"),n(e)])]),C,a("h3",D,[H,s(" 4. "),a("a",R,[s("script"),n(e)])]),z,a("h3",O,[G,s(" 5. "),a("a",T,[s("file"),n(e)])]),U,a("h3",W,[X,s(" 6. "),a("a",J,[s("yum"),n(e)])]),K,a("h3",Q,[Z,s(" 7. "),a("a",$,[s("systemd"),n(e)])]),aa,a("h3",sa,[na,s(" 8. "),a("a",ea,[s("cron"),n(e)])]),ta,a("p",null,[s("\u5BF9\u4E8E\u5982\u4F55\u826F\u597D\u7684\u5B9E\u8DF5\u8FD9\u4E9B\u5185\u5BB9\uFF0C\u6709\u4E00\u4E9B\u6574\u5957\u7684 "),a("a",oa,[s("playbooks"),n(e)]),s("\u3002")]),pa],64)}var ma=u(m,[["render",la]]);export{ma as default};
