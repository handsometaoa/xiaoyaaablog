import{r as e,o as t,a as p,b as c,d as n,e as o,w as l,F as r,c as a}from"./app.7138fe66.js";import{_ as i}from"./plugin-vue_export-helper.5a098b48.js";const k={},u=a('<h1 id="\u4E3B\u4ECE-nginx" tabindex="-1"><a class="header-anchor" href="#\u4E3B\u4ECE-nginx" aria-hidden="true">#</a> \u4E3B\u4ECE Nginx</h1><h2 id="\u51C6\u5907" tabindex="-1"><a class="header-anchor" href="#\u51C6\u5907" aria-hidden="true">#</a> \u51C6\u5907</h2><table><thead><tr><th>name</th><th>ip</th><th>role</th></tr></thead><tbody><tr><td>web01</td><td>10.0.0.133</td><td>MASTER</td></tr><tr><td>web02</td><td>10.0.0.134</td><td>BACKUP</td></tr></tbody></table>',3),d=a(`<p>\u4FEE\u6539 Nginx \u7684\u4E3B\u9875\u4FBF\u4E8E\u4E4B\u540E\u8BC6\u522B\uFF1A</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">vim</span> /usr/local/nginx/html/index.html
...
</code></pre></div><p>\u5F00\u653E\u7AEF\u53E3\uFF1A</p><div class="language-bash ext-sh"><pre class="language-bash"><code>firewall-cmd <span class="token parameter variable">--zone</span><span class="token operator">=</span>public --add-port<span class="token operator">=</span><span class="token number">80</span>/tcp
</code></pre></div><p>\u9A8C\u8BC1\u7ED3\u679C\uFF1A</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">curl</span> <span class="token parameter variable">-i</span> <span class="token number">10.0</span>.0.133
...
<span class="token number">2</span>: eth0: <span class="token operator">&lt;</span>BROADCAST,MULTICAST,UP,LOWER_UP<span class="token operator">&gt;</span> mtu <span class="token number">1500</span> qdisc pfifo_fast state UP group default qlen <span class="token number">1000</span>
    ...
    inet6 fe80::5883:fca9:d7da:bd43/64 scope <span class="token function">link</span> tentative noprefixroute dadfailed 
       valid_lft forever preferred_lft forever
</code></pre></div><h3 id="_2-\u6D4B\u8BD5" tabindex="-1"><a class="header-anchor" href="#_2-\u6D4B\u8BD5" aria-hidden="true">#</a> 2. \u6D4B\u8BD5</h3><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">curl</span> <span class="token parameter variable">-i</span> <span class="token number">10.0</span>.0.100 <span class="token comment"># \u865A\u62DF ip</span>
<span class="token comment"># &lt;h1&gt;Welcome to nginx1!&lt;/h1&gt;</span>
...
<span class="token comment"># &lt;h1&gt;Welcome to nginx2!&lt;/h1&gt;</span>
</code></pre></div>`,18);function m(h,f){const s=e("RouterLink");return t(),p(r,null,[u,c("p",null,[n("\u4E3A\u865A\u62DF\u673A"),o(s,{to:"/backend/nginx/install-nginx.html#%E7%BC%96%E8%AF%91%E5%AE%89%E8%A3%85"},{default:l(()=>[n("\u5B89\u88C5")]),_:1}),n("\u597D Nginx \u548C keepalived\u3002")]),d],64)}var _=i(k,[["render",m]]);export{_ as default};
