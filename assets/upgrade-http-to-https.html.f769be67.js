import{r as o,o as p,a as c,b as a,d as n,e,F as r,c as t}from"./app.7138fe66.js";import{_ as i}from"./plugin-vue_export-helper.5a098b48.js";const l={},u=t(`<h1 id="nginx-\u81F3-https" tabindex="-1"><a class="header-anchor" href="#nginx-\u81F3-https" aria-hidden="true">#</a> Nginx \u81F3 HTTPS</h1><p>HTTPS\uFF08HyperText Transfer Protocol Secure\uFF09\u5373\u8D85\u6587\u672C\u4F20\u8F93\u5B89\u5168\u534F\u8BAE\u3002HTTPS \u7ECF\u7531 HTTP \u8FDB\u884C\u901A\u4FE1\uFF0C\u4F46\u5229\u7528 SSL/TLS \u6765\u52A0\u5BC6\u6570\u636E\u5305\u3002</p><h2 id="\u589E\u52A0-ssl-\u6A21\u5757" tabindex="-1"><a class="header-anchor" href="#\u589E\u52A0-ssl-\u6A21\u5757" aria-hidden="true">#</a> \u589E\u52A0 SSL \u6A21\u5757</h2><p>\u90E8\u5206\u65E9\u671F\u7F16\u8BD1\u5B89\u88C5\u7684 nginx \u7F3A\u4E4F ssl \u6A21\u5757\uFF0C\u5148\u67E5\u770B\u4E00\u4E0B\u5F53\u524D\u6A21\u5757\uFF1A</p><div class="language-bash ext-sh"><pre class="language-bash"><code>/path/sbin/nginx <span class="token parameter variable">-V</span>
</code></pre></div><p>\u56DE\u5230\u5B89\u88C5\u5305\u4F4D\u7F6E\uFF0C\u627E\u5230 <code>configure</code> \u6587\u4EF6\uFF1A</p><div class="language-bash ext-sh"><pre class="language-bash"><code>./configure <span class="token parameter variable">--prefix</span><span class="token operator">=</span>/usr/local/nginx --with-http_ssl_module
...
</code></pre></div><h2 id="\u963F\u91CC\u4E91\u8BC1\u4E66" tabindex="-1"><a class="header-anchor" href="#\u963F\u91CC\u4E91\u8BC1\u4E66" aria-hidden="true">#</a> \u963F\u91CC\u4E91\u8BC1\u4E66</h2><h3 id="_1-\u7533\u8BF7\u8BC1\u4E66" tabindex="-1"><a class="header-anchor" href="#_1-\u7533\u8BF7\u8BC1\u4E66" aria-hidden="true">#</a> 1. \u7533\u8BF7\u8BC1\u4E66</h3>`,11),h={href:"https://common-buy.aliyun.com/?spm=5176.2020520163.cas.3.646456a7X7VPVZ&commodityCode=cas#/buy",target:"_blank",rel:"noopener noreferrer"},d=t(`<p>\u70B9\u51FB\u7533\u8BF7\uFF0C\u7136\u540E\u7ED1\u5B9A\u57DF\u540D\u5373\u53EF\uFF0C\u4F8B\u5982 <code>blog.shanyuhai.top</code>\uFF0C\u7A0D\u7B49\u7247\u523B\u5373\u53EF\u7B49\u5F85\u5BA1\u6838\u5B8C\u6210\u3002</p><h3 id="_2-\u5B89\u88C5\u8BC1\u4E66" tabindex="-1"><a class="header-anchor" href="#_2-\u5B89\u88C5\u8BC1\u4E66" aria-hidden="true">#</a> 2. \u5B89\u88C5\u8BC1\u4E66</h3><p>\u627E\u5230\u57DF\u540D\u5BF9\u5E94\u7684\u8BC1\u4E66\uFF0C\u4E0B\u8F7D\u81F3\u672C\u5730\uFF0C\u7136\u540E\u4E0A\u4F20\u81F3\u670D\u52A1\u5668\u3002</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token comment"># \u521B\u5EFA\u8BC1\u4E66\u76EE\u5F55</span>
...
</code></pre></div><h2 id="let-s-encrypt-\u8BC1\u4E66" tabindex="-1"><a class="header-anchor" href="#let-s-encrypt-\u8BC1\u4E66" aria-hidden="true">#</a> Let&#39;s Encrypt \u8BC1\u4E66</h2><h3 id="_1-\u8BF4\u660E" tabindex="-1"><a class="header-anchor" href="#_1-\u8BF4\u660E" aria-hidden="true">#</a> 1. \u8BF4\u660E</h3>`,11),g={href:"https://certbot.eff.org/instructions",target:"_blank",rel:"noopener noreferrer"},k=a("blockquote",null,[a("p",null,"\u8FD8\u539F\u963F\u91CC\u4E91\u505A\u7684\u914D\u7F6E\uFF0C\u5E76\u6253\u5F00\u7F51\u7AD9\u9A8C\u8BC1\u662F\u5426\u8FD8\u539F\u3002")],-1),b={href:"https://certbot.eff.org/lets-encrypt/ubuntubionic-nginx",target:"_blank",rel:"noopener noreferrer"},m=t(`<h3 id="_2-add-certbot-ppa" tabindex="-1"><a class="header-anchor" href="#_2-add-certbot-ppa" aria-hidden="true">#</a> 2. Add Certbot PPA</h3><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">apt-get</span> update
...
</code></pre></div>`,9);function f(_,x){const s=o("OutboundLink");return p(),c(r,null,[u,a("p",null,[n("\u963F\u91CC\u4E91\u4E5F\u63D0\u4F9B\u4E86 SSL \u8BC1\u4E66\u7684\u529F\u80FD\uFF0C\u8D2D\u4E70"),a("a",h,[n("\u514D\u8D39\u578B DV SSL"),e(s)]),n("\uFF08\u5728\u5C0F\u5B57\u63D0\u793A\u4E2D\u53EF\u4EE5\u6CE8\u610F\u5230\u514D\u8D39\u8BC1\u4E66\u53EF\u4EE5\u7533\u8BF7 20 \u4E2A\uFF09\uFF0C\u8D2D\u4E70\u6210\u529F\u540E\u4F1A\u5728 SSL \u8BC1\u4E66\u63A7\u5236\u53F0\u770B\u5230\u4E00\u4E2A\u672A\u7B7E\u53D1\u7684\u8BC1\u4E66\u3002")]),d,a("p",null,[n("Let's Encrypt \u63D0\u4F9B\u7684 "),a("a",g,[n("certbot"),e(s)]),n(" \u53EF\u4EE5\u5FEB\u901F\u751F\u6210\u8BC1\u4E66\uFF0C\u5E76\u80FD\u591F\u81EA\u52A8\u5B8C\u6210\u914D\u7F6E\u3002")]),k,a("p",null,[n("\u9009\u62E9 Nginx \u548C Ubuntu 18.04 \u540E\u5C31\u4F1A\u5F39\u51FA\u5BF9\u5E94\u7684"),a("a",b,[n("\u5B89\u88C5\u6B65\u9AA4"),e(s)]),n("\u3002")]),m],64)}var S=i(l,[["render",f]]);export{S as default};
