...
</code></pre></div><h2 id="\u6267\u884C\u6D4B\u8BD5" tabindex="-1"><a class="header-anchor" href="#\u6267\u884C\u6D4B\u8BD5" aria-hidden="true">#</a> \u6267\u884C\u6D4B\u8BD5</h2><div class="language-bash ext-sh"><pre class="language-bash"><code>kubectl apply <span class="token parameter variable">-f</span> mysql-pv-pvc.yaml
...
</code></pre></div><h3 id="_1-\u66F4\u65B0\u6570\u636E\u5E93" tabindex="-1"><a class="header-anchor" href="#_1-\u66F4\u65B0\u6570\u636E\u5E93" aria-hidden="true">#</a> 1. \u66F4\u65B0\u6570\u636E\u5E93</h3><div class="language-bash ext-sh"><pre class="language-bash"><code>kubectl run <span class="token parameter variable">-it</span> <span class="token parameter variable">--rm</span> <span class="token parameter variable">--image</span><span class="token operator">=</span>mysql:5.6 <span class="token parameter variable">--restart</span><span class="token operator">=</span>Never mysql-client -- mysql <span class="token parameter variable">-h</span> mysql <span class="token parameter variable">-ppassword</span>
...
</code></pre></div><h3 id="_3-\u9A8C\u8BC1\u6570\u636E\u4E00\u81F4\u6027" tabindex="-1"><a class="header-anchor" href="#_3-\u9A8C\u8BC1\u6570\u636E\u4E00\u81F4\u6027" aria-hidden="true">#</a> 3. \u9A8C\u8BC1\u6570\u636E\u4E00\u81F4\u6027</h3><div class="language-bash ext-sh"><pre class="language-bash"><code>kubectl run <span class="token parameter variable">-it</span> <span class="token parameter variable">--rm</span> <span class="token parameter variable">--image</span><span class="token operator">=</span>mysql:5.6 <span class="token parameter variable">--restart</span><span class="token operator">=</span>Never mysql-client -- mysql <span class="token parameter variable">-h</span> mysql <span class="token parameter variable">-ppassword</span>
...
+------+
</code></pre></div>`,27);function t(p,o){return e}var u=n(s,[["render",t]]);export{u as default};
