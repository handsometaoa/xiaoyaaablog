...
<span class="token assign-left variable">gpgkey</span><span class="token operator">=</span>https://nginx.org/keys/nginx_signing.key
</code></pre></div><h2 id="\u542F\u7528\u914D\u7F6E" tabindex="-1"><a class="header-anchor" href="#\u542F\u7528\u914D\u7F6E" aria-hidden="true">#</a> \u542F\u7528\u914D\u7F6E</h2><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">sudo</span> yum-config-manager <span class="token parameter variable">--enable</span> nginx-mainline
...
</code></pre></div>`,9);function t(p,o){return e}var r=n(s,[["render",t]]);export{r as default};
