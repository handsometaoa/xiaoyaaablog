...
<span class="token punctuation">}</span>
</code></pre></div>`,4);function E(I,N){const s=o("OutboundLink");return p(),c(i,null,[d,k,n("p",null,[u,n("a",_,[h,e(s)]),m]),x,n("p",null,[n("a",v,[g,e(s)]),b]),y,n("p",null,[n("a",f,[w,e(s)]),z]),q,n("p",null,[n("a",C,[D,e(s)]),S]),$],64)}var P=l(r,[["render",E]]);export{P as default};
