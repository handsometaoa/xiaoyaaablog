...
</code></pre></div><h2 id="\u5185\u7F6E\u7684\u5DE5\u5177\u7C7B\u578B" tabindex="-1"><a class="header-anchor" href="#\u5185\u7F6E\u7684\u5DE5\u5177\u7C7B\u578B" aria-hidden="true">#</a> \u5185\u7F6E\u7684\u5DE5\u5177\u7C7B\u578B</h2><p>\u60F3\u6210\u4E3A\u4E00\u4E2A\u597D\u7684 TypeScript \u5F00\u53D1\u8005\uFF0C\u90A3\u5FC5\u987B\u719F\u7EC3\u4F7F\u7528\u5B83\u7684\u5DE5\u5177\u7C7B\u578B\u3002</p><h3 id="\u524D\u7F6E\u6761\u4EF6" tabindex="-1"><a class="header-anchor" href="#\u524D\u7F6E\u6761\u4EF6" aria-hidden="true">#</a> \u524D\u7F6E\u6761\u4EF6</h3>`,31),y={href:"https://www.typescriptlang.org/docs/handbook/generics.html",target:"_blank",rel:"noopener noreferrer"},m={href:"https://www.typescriptlang.org/docs/handbook/2/types-from-types.html",target:"_blank",rel:"noopener noreferrer"},g=t(`<h4 id="_1-keyof-type-operator" tabindex="-1"><a class="header-anchor" href="#_1-keyof-type-operator" aria-hidden="true">#</a> 1. Keyof Type Operator</h4><p><code>keyof</code> \u53EF\u7528\u6765\u83B7\u53D6 \u201C\u5BF9\u8C61\u7C7B\u578B\u201D \u7684 <code>key</code>\uFF0C\u5E76\u7EC4\u6210 <code>union</code>\u3002</p><div class="language-tsx ext-tsx"><pre class="language-tsx"><code><span class="token keyword">type</span> <span class="token class-name">Point</span> <span class="token operator">=</span> <span class="token punctuation">{</span>
...
<span class="token comment">// }</span>
</code></pre></div><h4 id="_6-template-literal-types" tabindex="-1"><a class="header-anchor" href="#_6-template-literal-types" aria-hidden="true">#</a> 6. Template Literal Types</h4><p>\u5F88\u597D\uFF0C\u5C31\u5DEE\u652F\u6301\u6B63\u5219\u4E86\u3002</p><h4 id="_7-extends-in" tabindex="-1"><a class="header-anchor" href="#_7-extends-in" aria-hidden="true">#</a> 7. extends &amp; in</h4>`,21),h=n("code",null,"extends",-1),x=n("code",null,"in",-1),w={href:"https://stackoverflow.com/questions/57337598/in-typescript-what-do-extends-keyof-and-in-keyof-mean",target:"_blank",rel:"noopener noreferrer"},b=t(`<p>\u5728\u6CDB\u578B\u4E0A\u63D0\u524D\u505A\u7EA6\u675F\u53EF\u4EE5\u89E3\u51B3\u4E00\u4E9B\u95EE\u9898\uFF1A</p><div class="language-tsx ext-tsx"><pre class="language-tsx"><code><span class="token keyword">function</span> <span class="token generic-function"><span class="token function">prop</span><span class="token generic class-name"><span class="token operator">&lt;</span><span class="token constant">T</span><span class="token punctuation">,</span> <span class="token constant">K</span> <span class="token keyword">extends</span> <span class="token keyword">keyof</span> <span class="token constant">T</span><span class="token operator">&gt;</span></span></span> <span class="token punctuation">(</span>obj<span class="token operator">:</span> <span class="token constant">T</span><span class="token punctuation">,</span> key<span class="token operator">:</span> <span class="token constant">K</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
</code></pre></div><p>Example\uFF1A</p><div class="language-tsx ext-tsx"><pre class="language-tsx"><code><span class="token keyword">declare</span> <span class="token keyword">function</span> <span class="token function">f1</span><span class="token punctuation">(</span>arg<span class="token operator">:</span> <span class="token punctuation">{</span> a<span class="token operator">:</span> <span class="token builtin">number</span><span class="token punctuation">;</span> b<span class="token operator">:</span> <span class="token builtin">string</span> <span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token operator">:</span> <span class="token keyword">void</span><span class="token punctuation">;</span>
...
</code></pre></div><p>Example\uFF1A</p><div class="language-tsx ext-tsx"><pre class="language-tsx"><code><span class="token keyword">function</span> <span class="token function">toHex</span> <span class="token punctuation">(</span><span class="token keyword">this</span><span class="token operator">:</span> Number<span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
</code></pre></div><h2 id="typescript-\u5DE5\u5177" tabindex="-1"><a class="header-anchor" href="#typescript-\u5DE5\u5177" aria-hidden="true">#</a> TypeScript \u5DE5\u5177</h2>`,88),f={href:"https://www.typescriptlang.org/play",target:"_blank",rel:"noopener noreferrer"},T=n("p",null,"\u5728\u7EBF TypeScript \u8FD0\u884C\u73AF\u5883",-1),v={href:"http://www.jsontots.com/",target:"_blank",rel:"noopener noreferrer"},_=n("p",null,"\u6839\u636E JSON \u751F\u6210 typescript \u7684\u5DE5\u5177\uFF0C\u5F88\u8D5E",-1),P=n("h2",{id:"\u53C2\u8003\u8D44\u6599",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#\u53C2\u8003\u8D44\u6599","aria-hidden":"true"},"#"),s(" \u53C2\u8003\u8D44\u6599")],-1),R={href:"https://www.typescriptlang.org/docs",target:"_blank",rel:"noopener noreferrer"},O={href:"https://www.typescriptlang.org/tsconfig",target:"_blank",rel:"noopener noreferrer"},E={href:"https://devblogs.microsoft.com/typescript/",target:"_blank",rel:"noopener noreferrer"},K={href:"https://github.com/microsoft/TypeScript/tree/spec-update/doc/spec",target:"_blank",rel:"noopener noreferrer"};function D(C,U){const a=e("OutboundLink");return o(),c(l,null,[i,n("p",null,[n("a",u,[s("interface"),p(a)]),s(" \u4ECE\u5B98\u7F51\u770B\u6765\u53EF\u4EE5\u63CF\u8FF0\uFF1A\u5BF9\u8C61\u3001\u51FD\u6570\u3001\u6570\u7EC4\u3001Class\u3002")]),d,n("p",null,[n("a",y,[s("\u6CDB\u578B"),p(a)]),s("\u662F\u4E00\u5207\u5DE5\u5177\u7C7B\u578B\u7684\u57FA\u7840\uFF0C\u53EF\u4EE5\u5F53\u4F5C\u51FD\u6570\u4E2D\u7684\u5165\u53C2\uFF0C\u800C\u60F3\u8981\u8FDB\u4E00\u6B65\u5219\u8FD8\u9700\u8981\u501F\u52A9 "),n("a",m,[s("Type Manipulation"),p(a)]),s("\u3002")]),g,n("p",null,[h,s(" \u548C "),x,s(" \u90FD\u53EF\u4EE5\u4F5C\u4E3A\u7EA6\u675F\u884C\u4E3A\uFF0C\u5B9E\u9645\u4F7F\u7528\u4E2D\u662F\u8BA9\u4EBA"),n("a",w,[s("\u7591\u60D1\u7684"),p(a)]),s("\uFF0C\u5176\u4E2D\u4E00\u6761\u8BC4\u8BBA\u4E0D\u77E5\u662F\u5426\u6B63\u786E\uFF1A\u201Cextends \u603B\u662F\u7528\u5728\u6CDB\u578B\u4E0A\uFF0Cin \u603B\u662F\u7528\u5728\u7D22\u5F15\u4E0A\u201D\u3002")]),b,n("ul",null,[n("li",null,[n("p",null,[n("a",f,[s("TypeScript Playground"),p(a)])]),T]),n("li",null,[n("p",null,[n("a",v,[s("JSON TO TS"),p(a)])]),_])]),P,n("ol",null,[n("li",null,[n("a",R,[s("TypeScript"),p(a)])]),n("li",null,[n("a",O,[s("TSConfig Reference"),p(a)])]),n("li",null,[n("a",E,[s("TypeScript Blogs"),p(a)])]),n("li",null,[n("a",K,[s("TypeScript Spec"),p(a)])])])],64)}var S=r(k,[["render",D]]);export{S as default};
