import{r as t,o as r,a as c,b as a,d as n,e,F as p,c as o}from"./app.7138fe66.js";import{_ as l}from"./plugin-vue_export-helper.5a098b48.js";const i={},d=o('<h1 id="\u4EBA\u751F\u82E6\u77ED-\u6211\u7528-docker" tabindex="-1"><a class="header-anchor" href="#\u4EBA\u751F\u82E6\u77ED-\u6211\u7528-docker" aria-hidden="true">#</a> \u4EBA\u751F\u82E6\u77ED\uFF0C\u6211\u7528 Docker</h1><h2 id="\u4ECB\u7ECD" tabindex="-1"><a class="header-anchor" href="#\u4ECB\u7ECD" aria-hidden="true">#</a> \u4ECB\u7ECD</h2><p>Docker \u5229\u7528\u4E86 Linux \u5185\u6838\u7279\u6027\u547D\u540D\u7A7A\u95F4\uFF08namespace\uFF09\u53CA\u63A7\u5236\u7EC4\uFF08cgroups\uFF09\u7B49\u4E3A\u5BB9\u5668\u63D0\u4F9B\u9694\u79BB\u7684\u8FD0\u884C\u73AF\u5883\uFF0C\u5728\u6B64\u57FA\u7840\u4E0A\u53EF\u4EE5\u8BA4\u4E3A \u201C\u5BB9\u5668\u662F\u4E00\u79CD\u7279\u6B8A\u7684\u8FDB\u7A0B\u201D\u3002</p><h2 id="\u4F7F\u7528\u811A\u672C\u5FEB\u901F\u542F\u7528-docker" tabindex="-1"><a class="header-anchor" href="#\u4F7F\u7528\u811A\u672C\u5FEB\u901F\u542F\u7528-docker" aria-hidden="true">#</a> \u4F7F\u7528\u811A\u672C\u5FEB\u901F\u542F\u7528 Docker</h2>',4),u={href:"https://docs.docker.com/engine/install/",target:"_blank",rel:"noopener noreferrer"},h=o(`<div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">curl</span> <span class="token parameter variable">-fsSL</span> https://get.docker.com <span class="token parameter variable">-o</span> get-docker.sh
...
</code></pre></div><p>\u5982\u679C\u62C5\u5FC3\u811A\u672C\u5F02\u5E38\uFF0C\u53EF\u4EE5\u4E0B\u8F7D\u5E76\u8FDB\u884C\u5BA1\u6838\u3002</p><p>\u63A5\u7740\u5C31\u53EF\u4EE5\u5F00\u59CB\u6109\u5FEB\u7684\u4F7F\u7528\u4E86\uFF0C\u4F8B\u884C\u4E60\u60EF Hello World\uFF1A</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">docker</span> run hello-world
...
</code></pre></div><h2 id="\u521D\u59CB\u5316-docker-\u73AF\u5883" tabindex="-1"><a class="header-anchor" href="#\u521D\u59CB\u5316-docker-\u73AF\u5883" aria-hidden="true">#</a> \u521D\u59CB\u5316 Docker \u73AF\u5883</h2><h3 id="\u8BBE\u7F6E\u7528\u6237\u7EC4" tabindex="-1"><a class="header-anchor" href="#\u8BBE\u7F6E\u7528\u6237\u7EC4" aria-hidden="true">#</a> \u8BBE\u7F6E\u7528\u6237\u7EC4</h3><p>\u4E3A\u4E86\u907F\u514D\u6BCF\u6B21\u4F7F\u7528 Docker \u90FD\u9700\u8981\u5207\u6362\u5230 <code>sudo</code>\uFF0C\u53EF\u4EE5\u5C06 <code>docker</code> \u52A0\u5165\u5F53\u524D\u7528\u6237\u3002\u91CD\u65B0\u767B\u5F55\u540E\u751F\u6548\u3002</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">groupadd</span> <span class="token function">docker</span>
...
</code></pre></div><h3 id="\u955C\u50CF\u52A0\u901F" tabindex="-1"><a class="header-anchor" href="#\u955C\u50CF\u52A0\u901F" aria-hidden="true">#</a> \u955C\u50CF\u52A0\u901F</h3><p>\u955C\u50CF\u670D\u52A1\u53EF\u7528\uFF1A</p>`,10),k={href:"https://cr.console.aliyun.com/cn-hangzhou/instances/mirrors",target:"_blank",rel:"noopener noreferrer"},m={href:"https://www.163yun.com/help/documents/56918246390157312",target:"_blank",rel:"noopener noreferrer"},b=o(`<p>\u4FEE\u6539\u672C\u5730\u7684 <code>/etc/docker/daemon.json</code> \u5E76\u4FEE\u6539 <code>registry-mirrors</code>\uFF0C\u53EF\u4E3A\u5176\u914D\u7F6E\u591A\u4E2A\u907F\u514D\u67D0\u4E2A\u6302\u6389\uFF1A</p><div class="language-json ext-json"><pre class="language-json"><code><span class="token punctuation">{</span>
...
</code></pre></div><h3 id="node-js" tabindex="-1"><a class="header-anchor" href="#node-js" aria-hidden="true">#</a> Node.js</h3>`,11),g={href:"https://hub.docker.com/layers/node/library/node/erbium-buster-slim/images/sha256-c6ad96c5345c1a714e0052d08d83635c8e422ea0d103adc7f9f2df4fcfb7fe2d?context=explore",target:"_blank",rel:"noopener noreferrer"},f=o(`<div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token comment"># \u8FFD\u52A0 bash\uFF0C\u5426\u5219\u4F1A\u76F4\u63A5\u8FDB\u5165 node</span>
<span class="token function">docker</span> run <span class="token parameter variable">-it</span> <span class="token parameter variable">--rm</span> node:slim <span class="token function">bash</span>
</code></pre></div><h3 id="nginx" tabindex="-1"><a class="header-anchor" href="#nginx" aria-hidden="true">#</a> Nginx</h3><p>\u5FEB\u901F\u6D4B\u8BD5\u672C\u5730\u6253\u5305\u597D\u7684\u9759\u6001\u6587\u4EF6\u3002</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">docker</span> run <span class="token parameter variable">--rm</span> <span class="token punctuation">\\</span>
  ...
  nginx
</code></pre></div><h3 id="mysql" tabindex="-1"><a class="header-anchor" href="#mysql" aria-hidden="true">#</a> MySQL</h3><p>\u6307\u5B9A\u5BC6\u7801\u3002</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">docker</span> run <span class="token parameter variable">--rm</span> <span class="token punctuation">\\</span>
  ...
  mysql
</code></pre></div><h3 id="mongo" tabindex="-1"><a class="header-anchor" href="#mongo" aria-hidden="true">#</a> Mongo</h3><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">docker</span> run <span class="token parameter variable">-d</span> <span class="token punctuation">\\</span>
...
</code></pre></div><h3 id="redis" tabindex="-1"><a class="header-anchor" href="#redis" aria-hidden="true">#</a> Redis</h3><p>\u6307\u5B9A\u5BC6\u7801\u3002</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">docker</span> run <span class="token parameter variable">-d</span> <span class="token punctuation">\\</span>
...
</code></pre></div><h2 id="\u53C2\u8003\u8D44\u6599" tabindex="-1"><a class="header-anchor" href="#\u53C2\u8003\u8D44\u6599" aria-hidden="true">#</a> \u53C2\u8003\u8D44\u6599</h2>`,16),v={href:"https://docs.docker.com/",target:"_blank",rel:"noopener noreferrer"},x={href:"https://docs.docker.com/engine/reference/commandline/docker/",target:"_blank",rel:"noopener noreferrer"},_=a("li",null,"\u300ADocker \u6280\u672F\u5165\u95E8\u4E0E\u5B9E\u6218\uFF08\u7B2C\u4E09\u7248\uFF09\u300B",-1),y=a("li",null,"\u300A\u81EA\u5DF1\u52A8\u624B\u5199 Docker\u300B",-1);function D(w,q){const s=t("OutboundLink");return r(),c(p,null,[d,a("p",null,[n("\u5728\u8FC7\u53BB\u5E38\u5E38"),a("a",u,[n("\u624B\u52A8\u5B89\u88C5"),e(s)]),n("\uFF0C\u73B0\u5728\u5DF2\u7ECF\u5B8C\u5168\u5207\u6362\u4E3A\u811A\u672C\u5F62\u5F0F\u4E86\uFF1A")]),h,a("ol",null,[a("li",null,[a("a",k,[n("\u963F\u91CC\u4E91\u955C\u50CF\u670D\u52A1"),e(s)])]),a("li",null,[a("a",m,[n("\u7F51\u6613\u4E91\u955C\u50CF\u670D\u52A1"),e(s)])])]),b,a("p",null,[n("\u4ECE\u8FD9\u91CC\u57FA\u672C\u5C31\u53EF\u4EE5\u4E86\u89E3\u5230\u8FD9\u4E9B\u955C\u50CF\u53EA\u662F\u5728 Docker Engine \u4E0A\u589E\u52A0\u4E86\u4E00\u4E9B\u4F9D\u8D56\uFF0C\u7136\u540E\u4F60\u53C8\u57FA\u4E8E\u8FD9\u4E9B\u4F9D\u8D56\u642D\u5EFA\u4F60\u7684\u73AF\u5883\uFF0C\u53EF\u4EE5\u770B\u770B "),a("a",g,[n("Node Images Layers"),e(s)]),n(" \u52A0\u6DF1\u8BE5\u6982\u5FF5\u3002")]),f,a("ol",null,[a("li",null,[a("a",v,[n("Docker"),e(s)])]),a("li",null,[a("a",x,[n("Docker Commands"),e(s)])]),_,y])],64)}var T=l(i,[["render",D]]);export{T as default};
