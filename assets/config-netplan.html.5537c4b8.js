...
</code></pre></div><blockquote><p>\u6298\u817E\u8BB8\u4E45\uFF0C\u624D\u53D1\u73B0\u662F Linux \u5185\u6838\u4E0D\u652F\u6301\u8001\u7F51\u5361\u3002</p></blockquote><div class="language-bash ext-sh"><pre class="language-bash"><code>lshw <span class="token parameter variable">-C</span> network
...
</code></pre></div>`,14),u={href:"https://askubuntu.com/questions/765584/is-it-possible-to-use-broadcom-bcm43142-wifi-in-ubuntu-16-04",target:"_blank",rel:"noopener noreferrer"},k=a(`<div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">apt-get</span> update
...
</code></pre></div>`,7);function b(m,h){const e=t("OutboundLink");return o(),p(l,null,[d,n("p",null,[n("a",u,[s("\u89E3\u51B3\u65B9\u6848"),c(e)]),s("\uFF1A")]),k],64)}var v=r(i,[["render",b]]);export{v as default};
