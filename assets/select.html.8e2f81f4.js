...
</code></pre></div>`,31),u={href:"https://dev.mysql.com/doc/refman/8.0/en/numeric-functions.html",target:"_blank",rel:"noopener noreferrer"},i=a(`<h2 id="\u8BA1\u7B97\u5B57\u6BB5" tabindex="-1"><a class="header-anchor" href="#\u8BA1\u7B97\u5B57\u6BB5" aria-hidden="true">#</a> \u8BA1\u7B97\u5B57\u6BB5</h2><p>\u5F88\u591A\u65F6\u5019\u662F\u7531\u8BA1\u7B97\u8FD4\u56DE\u7684\u7ED3\u679C\u3002\u522B\u540D <code>alias</code> \u53EF\u7B80\u5199\u4E3A AS\uFF0C\u751A\u81F3\u8FD8\u53EF\u5FFD\u7565\u3002</p><div class="language-sql ext-sql"><pre class="language-sql"><code><span class="token keyword">SELECT</span> 
  vend_id<span class="token punctuation">,</span>
...
</code></pre></div>`,8);function E(m,_){const e=p("OutboundLink");return o(),t(r,null,[k,s("p",null,[n("\u66F4\u591A\u5185\u7F6E\u7684\u65B9\u6CD5\u53EF"),s("a",u,[n("\u53C2\u8003"),c(e)]),n("\u3002")]),i],64)}var w=d(l,[["render",E]]);export{w as default};
