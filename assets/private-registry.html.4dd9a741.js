import{r as o,o as t,a as c,b as a,d as e,e as n,F as p,c as r}from"./app.7138fe66.js";import{_ as l}from"./plugin-vue_export-helper.5a098b48.js";const i={},d=r(`<h1 id="\u4F7F\u7528-harbor-\u6784\u5EFA\u79C1\u6709\u955C\u50CF\u4ED3\u5E93" tabindex="-1"><a class="header-anchor" href="#\u4F7F\u7528-harbor-\u6784\u5EFA\u79C1\u6709\u955C\u50CF\u4ED3\u5E93" aria-hidden="true">#</a> \u4F7F\u7528 Harbor \u6784\u5EFA\u79C1\u6709\u955C\u50CF\u4ED3\u5E93</h1><h2 id="\u73AF\u5883" tabindex="-1"><a class="header-anchor" href="#\u73AF\u5883" aria-hidden="true">#</a> \u73AF\u5883</h2><p>\u521B\u5EFA\u4E00\u53F0\u865A\u62DF\u673A\u4E3A\u79C1\u6709\u4ED3\u5E93\uFF0C\u672C\u673A\u5411\u865A\u62DF\u673A\u7684\u4ED3\u5E93\u53D1\u8D77\u4E0A\u4F20\u548C\u4E0B\u8F7D\u3002</p><h2 id="\u642D\u5EFA\u4ED3\u5E93" tabindex="-1"><a class="header-anchor" href="#\u642D\u5EFA\u4ED3\u5E93" aria-hidden="true">#</a> \u642D\u5EFA\u4ED3\u5E93</h2><p>\u5728\u865A\u62DF\u673A\u4E0A\u521B\u5EFA\u4ED3\u5E93\uFF0C\u5E76\u6307\u5B9A\u955C\u50CF\u6587\u4EF6\u5B58\u653E\u5728\u672C\u5730\u7684\u9ED8\u8BA4\u8DEF\u5F84\uFF0C\u4E3A\u5176\u8BBE\u7F6E docker \u91CD\u542F\u540E\u8DDF\u968F\u91CD\u542F\u3002</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">docker</span> run <span class="token parameter variable">-d</span> <span class="token parameter variable">--restart</span><span class="token operator">=</span>always <span class="token parameter variable">--name</span> registry <span class="token parameter variable">-p</span> <span class="token number">5000</span>:5000 <span class="token parameter variable">-v</span> /opt/data/registry:/var/lib/registry registry
...
</code></pre></div><p>\u4E3B\u673A\u4E0A\u4F20\u955C\u50CF\u5230\u865A\u62DF\u673A\u4ED3\u5E93\u9A8C\u8BC1\u3002</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">docker</span> pull ubuntu
...
<span class="token comment"># \u9A8C\u8BC1</span>
<span class="token function">docker</span> images
</code></pre></div><h2 id="harbor" tabindex="-1"><a class="header-anchor" href="#harbor" aria-hidden="true">#</a> Harbor</h2>`,15),h={href:"https://github.com/goharbor/harbor",target:"_blank",rel:"noopener noreferrer"},u=r(`<h3 id="_1-\u83B7\u53D6-harbor" tabindex="-1"><a class="header-anchor" href="#_1-\u83B7\u53D6-harbor" aria-hidden="true">#</a> 1. \u83B7\u53D6 Harbor</h3><p>\u5148\u4E0B\u8F7D\u6587\u4EF6\u3002</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token comment"># \u76EE\u6807\u538B\u7F29\u5305</span>
...
</code></pre></div><h3 id="_3-\u91CD\u88C5" tabindex="-1"><a class="header-anchor" href="#_3-\u91CD\u88C5" aria-hidden="true">#</a> 3. \u91CD\u88C5</h3><p>\u5F53\u4FEE\u6539\u914D\u7F6E\u540E\u8FD0\u884C <code>bash prepare</code> \u5373\u53EF\u3002</p><h3 id="_4-\u7528\u6237" tabindex="-1"><a class="header-anchor" href="#_4-\u7528\u6237" aria-hidden="true">#</a> 4. \u7528\u6237</h3><p>Harbor \u4F7F\u7528\u524D\u9700\u8981\u6CE8\u518C\u5E10\u53F7\uFF0C\u63A8\u9001\u955C\u50CF\u524D\u9700\u8981\u5148\u521B\u5EFA\u9879\u76EE\uFF0C\u9080\u8BF7\u6210\u5458\u624D\u884C\u3002</p><h2 id="\u81EA\u7B7E\u8BC1\u4E66" tabindex="-1"><a class="header-anchor" href="#\u81EA\u7B7E\u8BC1\u4E66" aria-hidden="true">#</a> \u81EA\u7B7E\u8BC1\u4E66</h2><p>Harbor \u5728\u975E <code>https</code> \u7684\u73AF\u5883\u4E0B\u603B\u662F\u4F1A\u51FA\u73B0\u5404\u79CD\u5404\u6837\u7684\u95EE\u9898\uFF0C\u800C\u5185\u7F51\u4F7F\u7528\u65F6\u9700\u8981\u81EA\u7B7E\u8BC1\u4E66\u89E3\u51B3 <code>https</code> \u95EE\u9898\u3002</p>`,19),b={href:"https://goharbor.io/docs/2.1.0/install-config/configure-https/",target:"_blank",rel:"noopener noreferrer"},k=r(`<h3 id="_1-\u751F\u6210-ca-\u8BC1\u4E66" tabindex="-1"><a class="header-anchor" href="#_1-\u751F\u6210-ca-\u8BC1\u4E66" aria-hidden="true">#</a> 1. \u751F\u6210 CA \u8BC1\u4E66</h3><p>\u5148\u751F\u6210 <code>ca</code> \u79C1\u94A5\uFF1A</p><div class="language-bash ext-sh"><pre class="language-bash"><code>openssl genrsa <span class="token parameter variable">-out</span> ca.key <span class="token number">4096</span>
</code></pre></div><p>\u518D\u751F\u6210 <code>ca</code> \u8BC1\u4E66\uFF1A</p><div class="language-bash ext-sh"><pre class="language-bash"><code>openssl req <span class="token parameter variable">-x509</span> <span class="token parameter variable">-new</span> <span class="token parameter variable">-nodes</span> <span class="token parameter variable">-sha512</span> <span class="token parameter variable">-days</span> <span class="token number">3650</span> <span class="token punctuation">\\</span>
...
</code></pre></div><h3 id="_2-\u751F\u6210\u670D\u52A1\u7AEF\u8BC1\u4E66" tabindex="-1"><a class="header-anchor" href="#_2-\u751F\u6210\u670D\u52A1\u7AEF\u8BC1\u4E66" aria-hidden="true">#</a> 2. \u751F\u6210\u670D\u52A1\u7AEF\u8BC1\u4E66</h3><p>\u670D\u52A1\u7AEF\u8BC1\u4E66\u5305\u542B <code>.crt</code> \u53CA <code>.key</code> \u6587\u4EF6\u3002</p><p>\u5148\u751F\u6210\u57DF\u540D\u79C1\u94A5\uFF1A</p><div class="language-bash ext-sh"><pre class="language-bash"><code>openssl genrsa <span class="token parameter variable">-out</span> harbor.xxx.com.key <span class="token number">4096</span>
</code></pre></div><p>\u518D\u751F\u6210\u8BC1\u4E66\u7B7E\u540D\u8BF7\u6C42\uFF08Certificate Signing Request\uFF09\uFF1A</p><div class="language-bash ext-sh"><pre class="language-bash"><code>openssl req <span class="token parameter variable">-sha512</span> <span class="token parameter variable">-new</span> <span class="token punctuation">\\</span>
    <span class="token parameter variable">-subj</span> <span class="token string">&quot;/C=CN/ST=Beijing/L=Beijing/O=example/OU=Personal/CN=harbor.xxx.com&quot;</span> <span class="token punctuation">\\</span>
...
DNS.3=hostname
EOF</span>
</code></pre></div><p>\u6839\u636E <code>v3.ext</code> \u751F\u6210\u8BC1\u4E66\uFF1A</p><div class="language-bash ext-sh"><pre class="language-bash"><code>openssl x509 <span class="token parameter variable">-req</span> <span class="token parameter variable">-sha512</span> <span class="token parameter variable">-days</span> <span class="token number">3650</span> <span class="token punctuation">\\</span>
...
</code></pre></div><p>\u5C06 <code>crt</code> \u8F6C\u4E3A <code>cert</code>\uFF0C\u4EE5\u4F9B Docker client \u4F7F\u7528\uFF1A</p><div class="language-bash ext-sh"><pre class="language-bash"><code>openssl x509 <span class="token parameter variable">-inform</span> PEM <span class="token parameter variable">-in</span> harbor.xxx.com.crt <span class="token parameter variable">-out</span> harbor.xxx.com.cert
    ...
    \u2514\u2500\u2500 harbor.xxx.com
       ...
       \u251C\u2500\u2500 harbor.xxx.com.key
       \u2514\u2500\u2500 ca.crt
</code></pre></div><p>\u914D\u7F6E\u5B8C\u6210\u540E\u8FD8\u9700\u91CD\u542F Docker\u3002</p><h3 id="_4-\u6D4F\u89C8\u5668\u4F7F\u7528" tabindex="-1"><a class="header-anchor" href="#_4-\u6D4F\u89C8\u5668\u4F7F\u7528" aria-hidden="true">#</a> 4. \u6D4F\u89C8\u5668\u4F7F\u7528</h3><p>Manjaro \u4E0B\u627E\u5230 SSL \u8BBE\u7F6E\uFF0C\u6DFB\u52A0 <code>harbor.xxx.com.crt</code> \u8BC1\u4E66\u5373\u53EF\u3002</p><h3 id="_5-\u6CE8\u610F\u4E8B\u9879" tabindex="-1"><a class="header-anchor" href="#_5-\u6CE8\u610F\u4E8B\u9879" aria-hidden="true">#</a> 5. \u6CE8\u610F\u4E8B\u9879</h3>`,24),g=a("code",null,"push",-1),m={href:"https://github.com/goharbor/harbor/issues/13553",target:"_blank",rel:"noopener noreferrer"},x=a("code",null,"common/config/nginx/nginx.conf",-1),v=a("div",{class:"language-nginx ext-nginx"},[a("pre",{class:"language-nginx"},[a("code",null,[a("span",{class:"token comment"},"# When setting up Harbor behind other proxy, such as an Nginx instance, remove the below line if the proxy already has similar settings."),e(`
`),a("span",{class:"token comment"},"#proxy_set_header X-Forwarded-Proto $scheme;"),e(`
`)])])],-1);function f(_,y){const s=o("OutboundLink");return t(),c(p,null,[d,a("p",null,[e("\u53E6\u5916\u4E00\u4E2A\u9009\u62E9\u662F\u4F7F\u7528 "),a("a",h,[e("Harbor"),n(s)]),e("\u3002")]),u,a("p",null,[e("Harbor \u5B98\u7F51\u5BF9\u8FD9\u4E00\u90E8\u5206\u6709\u8BE6\u7EC6\u7684"),a("a",b,[e("\u8BF4\u660E"),n(s)]),e("\uFF0C\u6B64\u5904\u7A0D\u5FAE\u7B80\u5316\u3002")]),k,a("p",null,[e("\u5728\u4F7F\u7528 Nginx \u53CD\u5411\u4EE3\u7406 "),g,e(" \u5B58\u5728"),a("a",m,[e("\u95EE\u9898"),n(s)]),e("\u3002\u6839\u636E "),x,e(" \u4E2D\u7684\u63D0\u793A\u6CE8\u91CA\uFF0C\u9700\u6CE8\u610F\u4E0D\u6B62\u4E00\u5904\uFF1A")]),v],64)}var N=l(i,[["render",f]]);export{N as default};
