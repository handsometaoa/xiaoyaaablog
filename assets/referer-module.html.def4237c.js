...
<span class="token punctuation">}</span>
</code></pre></div><h2 id="\u6D4B\u8BD5" tabindex="-1"><a class="header-anchor" href="#\u6D4B\u8BD5" aria-hidden="true">#</a> \u6D4B\u8BD5</h2><h3 id="_1-example-com" tabindex="-1"><a class="header-anchor" href="#_1-example-com" aria-hidden="true">#</a> 1. *.example.com</h3><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">curl</span> <span class="token parameter variable">-e</span> <span class="token string">&#39;http://dev.example.com&#39;</span> nginx.example.com
...
</code></pre></div><h3 id="_2-example" tabindex="-1"><a class="header-anchor" href="#_2-example" aria-hidden="true">#</a> 2. example.*</h3><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">curl</span> <span class="token parameter variable">-ie</span> <span class="token string">&#39;http://example.org&#39;</span> nginx.example.com
<span class="token comment"># HTTP/1.1 200 OK</span>
<span class="token comment"># valid_referers</span>
...
<span class="token comment"># HTTP/1.1 200 OK</span>
<span class="token comment"># valid_referers</span>
</code></pre></div><h3 id="_3-nginx-example-top-foo" tabindex="-1"><a class="header-anchor" href="#_3-nginx-example-top-foo" aria-hidden="true">#</a> 3. nginx.example.top/foo/</h3><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">curl</span> <span class="token parameter variable">-ie</span> <span class="token string">&#39;http://nginx.example.top&#39;</span> nginx.example.com
<span class="token comment"># HTTP/1.1 403 Forbidden</span>
...
<span class="token comment"># HTTP/1.1 200 OK</span>
<span class="token comment"># valid_referers</span>
</code></pre></div>`,12);function p(t,o){return s}var l=a(e,[["render",p]]);export{l as default};
