...
kubectl get pod,svc
</code></pre></div>`,15);function w(S,N){const n=o("OutboundLink");return c(),r(l,null,[i,a("p",null,[u,a("a",h,[k,t(n)]),b]),g,a("p",null,[m,a("a",f,[_,t(n)]),v,x,y,E,O]),F],64)}var T=p(d,[["render",w]]);export{T as default};
