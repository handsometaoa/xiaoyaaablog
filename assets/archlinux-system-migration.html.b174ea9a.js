...
</code></pre></div>`,8);function B(w,A){const a=o("OutboundLink");return p(),c(l,null,[u,d,k,n("p",null,[h,n("a",m,[b,e(a)]),g]),f,n("p",null,[v,n("a",_,[x,e(a)]),q,L,y]),G],64)}var S=i(r,[["render",B]]);export{S as default};
