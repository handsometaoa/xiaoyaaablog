import{r as o,o as c,a as t,b as n,d as a,e as p,F as r,c as s}from"./app.7138fe66.js";import{_ as l}from"./plugin-vue_export-helper.5a098b48.js";const d={},i=s(`<h1 id="\u4E86\u89E3-docker-\u955C\u50CF" tabindex="-1"><a class="header-anchor" href="#\u4E86\u89E3-docker-\u955C\u50CF" aria-hidden="true">#</a> \u4E86\u89E3 Docker \u955C\u50CF</h1><h2 id="\u83B7\u53D6\u955C\u50CF" tabindex="-1"><a class="header-anchor" href="#\u83B7\u53D6\u955C\u50CF" aria-hidden="true">#</a> \u83B7\u53D6\u955C\u50CF</h2><div class="custom-container tip"><p class="custom-container-title">\u683C\u5F0F</p><p><code>docker pull [OPTIONS] NAME[:TAG|@DIGEST]</code>\u3002</p><p>NAME \u662F\u955C\u50CF\u4ED3\u5E93\u540D\u79F0\uFF08\u7528\u6765\u533A\u5206\u955C\u50CF\uFF09\uFF0CTAG \u662F\u955C\u50CF\u7684\u6807\u7B7E\uFF08\u5F80\u5F80\u7528\u6765\u8868\u793A\u7248\u672C\u4FE1\u606F\uFF09\u3002\u82E5\u4E0D\u6307\u5B9A TAG \u5219\u9ED8\u8BA4\u9009\u62E9 <code>latest</code>\uFF0C\u5373\u6700\u65B0\u7248\u672C\u3002</p></div><p>\u5728\u83B7\u53D6\u955C\u50CF\u524D\u53EF\u4EE5\u67E5\u8BE2\u662F\u5426\u5B58\u5728\u5BF9\u5E94\u7684\u955C\u50CF\u3002</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token comment"># docker search [OPTIONS] TERM</span>
<span class="token function">docker</span> search ubuntu
</code></pre></div><h2 id="\u955C\u50CF\u4FE1\u606F" tabindex="-1"><a class="header-anchor" href="#\u955C\u50CF\u4FE1\u606F" aria-hidden="true">#</a> \u955C\u50CF\u4FE1\u606F</h2><h3 id="_1-\u6240\u6709\u955C\u50CF\u6982\u89C8" tabindex="-1"><a class="header-anchor" href="#_1-\u6240\u6709\u955C\u50CF\u6982\u89C8" aria-hidden="true">#</a> 1. \u6240\u6709\u955C\u50CF\u6982\u89C8</h3><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">docker</span> images
...
</code></pre></div><h2 id="\u4FEE\u6539\u955C\u50CF" tabindex="-1"><a class="header-anchor" href="#\u4FEE\u6539\u955C\u50CF" aria-hidden="true">#</a> \u4FEE\u6539\u955C\u50CF</h2><h3 id="_1-\u6DFB\u52A0\u955C\u50CF\u6807\u7B7E" tabindex="-1"><a class="header-anchor" href="#_1-\u6DFB\u52A0\u955C\u50CF\u6807\u7B7E" aria-hidden="true">#</a> 1. \u6DFB\u52A0\u955C\u50CF\u6807\u7B7E</h3><p>\u4EC5\u6DFB\u52A0\u955C\u50CF\u6807\u7B7E\uFF0C\u5B9E\u9645 <code>IMAGE ID</code> \u6307\u5411\u540C\u4E00\u4E2A\u3002</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">docker</span> tag ubuntu:latest myubuntu:latest
...
</code></pre></div><h3 id="_3-\u6E05\u7406\u955C\u50CF" tabindex="-1"><a class="header-anchor" href="#_3-\u6E05\u7406\u955C\u50CF" aria-hidden="true">#</a> 3. \u6E05\u7406\u955C\u50CF</h3><p>\u7CFB\u7EDF\u4E2D\u53EF\u80FD\u4F1A\u9057\u7559\u4E00\u4E9B\u4E34\u65F6\u7684\u955C\u50CF\u6587\u4EF6\u3002</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">docker</span> image prune <span class="token punctuation">[</span>OPTIONS<span class="token punctuation">]</span>
</code></pre></div><h2 id="\u5206\u4EAB\u955C\u50CF" tabindex="-1"><a class="header-anchor" href="#\u5206\u4EAB\u955C\u50CF" aria-hidden="true">#</a> \u5206\u4EAB\u955C\u50CF</h2><h3 id="_1-save" tabindex="-1"><a class="header-anchor" href="#_1-save" aria-hidden="true">#</a> 1. save</h3><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">docker</span> images <span class="token comment"># \u5217\u51FA\u955C\u50CF</span>
...
</code></pre></div><h2 id="docker-slim-\u4F18\u5316\u955C\u50CF" tabindex="-1"><a class="header-anchor" href="#docker-slim-\u4F18\u5316\u955C\u50CF" aria-hidden="true">#</a> Docker slim \u4F18\u5316\u955C\u50CF</h2>`,44),h={href:"https://github.com/docker-slim/docker-slim/releases",target:"_blank",rel:"noopener noreferrer"},k=s(`<div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token comment"># \u4E0B\u8F7D</span>
...
</code></pre></div>`,3);function u(m,g){const e=o("OutboundLink");return c(),t(r,null,[i,n("p",null,[a("\u9996\u5148\u9700\u8981\u83B7\u53D6 "),n("a",h,[a("Docker Slim"),p(e)]),a("\u3002")]),k],64)}var v=l(d,[["render",u]]);export{v as default};
