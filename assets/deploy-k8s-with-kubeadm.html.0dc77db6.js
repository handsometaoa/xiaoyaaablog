...
EOF</span>
</code></pre></div><h2 id="\u521D\u59CB\u5316\u64CD\u4F5C" tabindex="-1"><a class="header-anchor" href="#\u521D\u59CB\u5316\u64CD\u4F5C" aria-hidden="true">#</a> \u521D\u59CB\u5316\u64CD\u4F5C</h2><h3 id="_1-\u5173\u95ED\u9632\u706B\u5899" tabindex="-1"><a class="header-anchor" href="#_1-\u5173\u95ED\u9632\u706B\u5899" aria-hidden="true">#</a> 1. \u5173\u95ED\u9632\u706B\u5899</h3>`,7),k={href:"https://kubernetes.io/zh/docs/setup/production-environment/tools/kubeadm/install-kubeadm/#check-required-ports",target:"_blank",rel:"noopener noreferrer"},u=s(`<div class="language-bash ext-sh"><pre class="language-bash"><code>systemctl stop firewalld
...
</code></pre></div><h3 id="_3-\u5173\u95ED-swap" tabindex="-1"><a class="header-anchor" href="#_3-\u5173\u95ED-swap" aria-hidden="true">#</a> 3. \u5173\u95ED swap</h3><div class="language-bash ext-sh"><pre class="language-bash"><code>swapoff <span class="token parameter variable">-a</span>
...
</code></pre></div><h3 id="_5-\u65F6\u95F4\u540C\u6B65" tabindex="-1"><a class="header-anchor" href="#_5-\u65F6\u95F4\u540C\u6B65" aria-hidden="true">#</a> 5. \u65F6\u95F4\u540C\u6B65</h3><div class="language-bash ext-sh"><pre class="language-bash"><code>yum <span class="token function">install</span> ntpdate <span class="token parameter variable">-y</span>
ntpdate ntp1.aliyun.com
</code></pre></div><h2 id="\u5B89\u88C5\u4F9D\u8D56" tabindex="-1"><a class="header-anchor" href="#\u5B89\u88C5\u4F9D\u8D56" aria-hidden="true">#</a> \u5B89\u88C5\u4F9D\u8D56</h2><h3 id="_1-\u5B89\u88C5-docker" tabindex="-1"><a class="header-anchor" href="#_1-\u5B89\u88C5-docker" aria-hidden="true">#</a> 1. \u5B89\u88C5 docker</h3><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">curl</span> <span class="token parameter variable">-fsSL</span> https://get.docker.com <span class="token parameter variable">-o</span> get-docker.sh
...
</code></pre></div><p>\u7136\u540E\u6839\u636E\u63D0\u793A\uFF1A</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">mkdir</span> <span class="token parameter variable">-p</span> <span class="token environment constant">$HOME</span>/.kube
...
</code></pre></div><h3 id="_3-\u589E\u52A0-cni-\u7F51\u7EDC\u63D2\u4EF6" tabindex="-1"><a class="header-anchor" href="#_3-\u589E\u52A0-cni-\u7F51\u7EDC\u63D2\u4EF6" aria-hidden="true">#</a> 3. \u589E\u52A0 CNI \u7F51\u7EDC\u63D2\u4EF6</h3><p>\u67E5\u770B nodes \u7684 STATUS \u8FD8\u662F NotReady\u3002\u662F\u7531\u4E8E\u5FC5\u987B\u90E8\u7F72\u4E00\u4E2A\u57FA\u4E8E Pod \u7F51\u7EDC\u63D2\u4EF6\u7684 \u5BB9\u5668\u7F51\u7EDC\u63A5\u53E3\uFF08CNI\uFF09\uFF0C\u4EE5\u4FBF\u4E8E Pod \u4E4B\u95F4\u4E92\u76F8\u901A\u4FE1\u3002</p><div class="language-bash ext-sh"><pre class="language-bash"><code>kubectl apply <span class="token parameter variable">-f</span> https://raw.githubusercontent.com/coreos/flannel/master/Documentation/kube-flannel.yml

kubectl get pods <span class="token parameter variable">-n</span> kube-system
</code></pre></div>`,34),h={href:"https://github.com/coreos/flannel/releases",target:"_blank",rel:"noopener noreferrer"},b=e("code",null,"docker pull",-1),m=e("code",null,"docker load",-1),g=s(`<p>\u6700\u540E\u5F97\u5230\uFF1A</p><div class="language-bash ext-sh"><pre class="language-bash"><code>NAME         STATUS     ROLES    AGE    VERSION
...
</code></pre></div><h2 id="\u6D4B\u8BD5" tabindex="-1"><a class="header-anchor" href="#\u6D4B\u8BD5" aria-hidden="true">#</a> \u6D4B\u8BD5</h2><div class="language-bash ext-sh"><pre class="language-bash"><code>kubectl create deployment nginx <span class="token parameter variable">--image</span><span class="token operator">=</span>nginx
...
kubectl get pod,svc
</code></pre></div>`,15);function f(v,_){const n=o("OutboundLink");return p(),r(c,null,[i,e("p",null,[a("\u65B9\u4FBF\u6D4B\u8BD5\uFF0C\u5177\u4F53\u53EF\u6839\u636E "),e("a",k,[a("\u68C0\u67E5\u6240\u9700\u7AEF\u53E3"),t(n)]),a("\u3002")]),u,e("p",null,[a("\u5982\u679C\u5B58\u5728 STATUS \u4E3A Init:ImagePullBackOff\uFF0C\u90A3\u4E48\u53EF\u524D\u5F80 yml \u914D\u7F6E\u6587\u4EF6\u5BFB\u627E"),e("a",h,[a("\u5BF9\u5E94\u7684\u955C\u50CF"),t(n)]),a("\uFF0C\u624B\u52A8 "),b,a(" \u6216 "),m,a("\u3002")]),g],64)}var E=l(d,[["render",f]]);export{E as default};
