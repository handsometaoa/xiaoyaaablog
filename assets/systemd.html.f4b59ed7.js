...
</code></pre></div><p>\u4E0A\u9762\u547D\u4EE4\u7684\u8F93\u51FA\u7ED3\u679C\u4E4B\u4E2D\uFF0C\u6709\u4E9B\u4F9D\u8D56\u662F Target \u7C7B\u578B\uFF08\u8BE6\u89C1\u4E0B\u6587\uFF09\uFF0C\u9ED8\u8BA4\u4E0D\u4F1A\u5C55\u5F00\u663E\u793A\u3002\u5982\u679C\u8981\u5C55\u5F00 Target\uFF0C\u5C31\u9700\u8981\u4F7F\u7528 <code>--all</code> \u53C2\u6570\u3002</p><div class="language-bash ext-sh"><pre class="language-bash"><code>systemctl list-dependencies <span class="token parameter variable">--all</span> nginx.service
...
</code></pre></div><h2 id="\u53C2\u8003\u6587\u7AE0" tabindex="-1"><a class="header-anchor" href="#\u53C2\u8003\u6587\u7AE0" aria-hidden="true">#</a> \u53C2\u8003\u6587\u7AE0</h2>`,16),k={href:"http://www.ruanyifeng.com/blog/2016/03/systemd-tutorial-commands.html",target:"_blank",rel:"noopener noreferrer"};function h(g,b){const a=c("OutboundLink");return o(),l(p,null,[d,s("p",null,[n("Unit \u914D\u7F6E\u6587\u4EF6\u7684\u5B8C\u6574\u5B57\u6BB5\u6E05\u5355\uFF0C\u8BF7\u53C2\u8003"),s("a",m,[n("\u5B98\u65B9\u6587\u6863"),e(a)]),n("\u3002")]),u,s("p",null,[s("a",k,[n("\u539F\u6587\uFF1ASystemd \u5165\u95E8\u6559\u7A0B"),e(a)])])],64)}var f=i(r,[["render",h]]);export{f as default};
