import{r as p,o,a as c,b as n,d as a,e as t,F as l,c as s}from"./app.7138fe66.js";import{_ as r}from"./plugin-vue_export-helper.5a098b48.js";const i={},u=s(`<h1 id="\u5982\u4F55\u642D\u5EFA\u79C1\u6709-gitlab" tabindex="-1"><a class="header-anchor" href="#\u5982\u4F55\u642D\u5EFA\u79C1\u6709-gitlab" aria-hidden="true">#</a> \u5982\u4F55\u642D\u5EFA\u79C1\u6709 GitLab</h1><h2 id="\u5B89\u88C5-gitlab" tabindex="-1"><a class="header-anchor" href="#\u5B89\u88C5-gitlab" aria-hidden="true">#</a> \u5B89\u88C5 GitLab</h2><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token comment"># \u521B\u5EFA\u6570\u636E\u76EE\u5F55</span>
...
</code></pre></div><p>\u6700\u540E\u6253\u5F00\u6D4F\u89C8\u5668\u6765\u9A8C\u8BC1\u3002</p><h2 id="\u90AE\u4EF6\u670D\u52A1" tabindex="-1"><a class="header-anchor" href="#\u90AE\u4EF6\u670D\u52A1" aria-hidden="true">#</a> \u90AE\u4EF6\u670D\u52A1</h2>`,5),k={href:"https://exmail.qq.com/",target:"_blank",rel:"noopener noreferrer"},d=n("code",null,"\u90AE\u7BB1 => \u90AE\u7BB1\u8BBE\u7F6E => \u6536\u53D1\u4FE1\u8BBE\u7F6E => \u5F00\u542FIMAP/SMTP\u670D\u52A1",-1),m=n("code",null,"\u90AE\u7BB1\u8BBE\u7F6E => \u90AE\u7BB1\u7ED1\u5B9A => \u5B89\u5168\u767B\u5F55",-1),g=s(`<h3 id="_1-\u4FEE\u6539\u914D\u7F6E" tabindex="-1"><a class="header-anchor" href="#_1-\u4FEE\u6539\u914D\u7F6E" aria-hidden="true">#</a> 1. \u4FEE\u6539\u914D\u7F6E</h3><p>\u627E\u5230 <code>Email Settings</code> \u5728\u540E\u9762\u8FFD\u52A0\u5BF9\u5E94\u7684 <code>SMTP</code> \u914D\u7F6E\u3002</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">vim</span> /srv/gitlab/config/gitlab.rb
...
</code></pre></div><p>\u66F4\u597D\u7684\u5F62\u5F0F\u662F\u5B9A\u671F\u5907\u4EFD\uFF1A</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">crontab</span> <span class="token parameter variable">-e</span>
...
</code></pre></div><h2 id="\u5FEB\u901F\u800C\u7B80\u5355\u7684\u5347\u7EA7" tabindex="-1"><a class="header-anchor" href="#\u5FEB\u901F\u800C\u7B80\u5355\u7684\u5347\u7EA7" aria-hidden="true">#</a> \u5FEB\u901F\u800C\u7B80\u5355\u7684\u5347\u7EA7</h2>`,19),b={href:"https://hub.docker.com/r/gitlab/gitlab-ce/tags",target:"_blank",rel:"noopener noreferrer"},h=s(`<div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">docker-compose</span> down
...
</code></pre></div><p>\u6700\u540E\u542F\u52A8 Runner\uFF1A</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">docker</span> run <span class="token parameter variable">-d</span> <span class="token punctuation">\\</span>
  <span class="token parameter variable">--restart</span> always <span class="token punctuation">\\</span>
  <span class="token parameter variable">-v</span> /srv/gitlab-runner/config:/etc/gitlab-runner <span class="token punctuation">\\</span>
...
</code></pre></div>`,1);function _(x,q){const e=p("OutboundLink");return o(),c(l,null,[u,n("p",null,[a("\u591A\u5BB6\u5BF9\u6BD4\u540E\u9009\u62E9\u4E86"),n("a",k,[a("\u817E\u8BAF\u4F01\u4E1A\u90AE\u7BB1"),t(e)]),a("\uFF0C\u4F9D\u6B21\u8FDB\u5165 "),d,a("\uFF0C\u518D\u56DE\u5230 "),m,a(" \u83B7\u53D6\u6388\u6743\u7801\u5373\u53EF\uFF08\u81F3\u4E8E\u914D\u7F6E\u57DF\u540D\uFF0C\u90AE\u4EF6\u914D\u7F6E\u53EF\u53E6\u884C\u8C37\u6B4C\uFF09\u3002")]),g,n("p",null,[a("\u4F7F\u7528 Docker Compose \u8FDB\u884C\u7EF4\u62A4\uFF0C\u627E\u5230\u65B0\u7684"),n("a",b,[a("\u955C\u50CF"),t(e)]),a("\u66FF\u6362\u4E0A\uFF0C\u6CE8\u610F\u5927\u7248\u672C\u7684\u5347\u7EA7\u53D8\u52A8\u3002")]),h,n("p",null,[a("\u6839\u636E "),n("a",v,[a("tls-self-signed"),t(e)]),a(" \u53BB\u4FE1\u4EFB ca\uFF1A")]),f],64)}var w=r(i,[["render",_]]);export{w as default};
